...
//
//  Created by Nadir Netaliyev on 29.04.2024.
//
...
extension UserInfoVC: GFFollowerItemVCDelegate {
    func didTapGetFollowers(for user: User) {
        guard user.followers != 0 else {
            presentGFAlertOnMainThread(title: "No followers", message: "This user has no followers, go follow them! 😃", buttonTitle: "So sad")
            return
        }
